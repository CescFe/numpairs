...
- [Feature request](.github/ISSUE_TEMPLATE/feature.md): ask for a new behavior
- [Bug report](.github/ISSUE_TEMPLATE/bug.md): report an unexpected defect in the app

Follow each template to provide the needed information to implement the issue.
