...
internal val TILE_SELECTION_SHEET_OPTION_CARD_MIN_WIDTH = 56.dp
internal val TILE_SELECTION_SHEET_OPTION_CARD_MAX_WIDTH = 76.dp
internal val TILE_SELECTION_SHEET_OPTION_MIN_HEIGHT = 50.dp
internal val TILE_OPERATOR_SHEET_PADDING = 20.dp
internal val TILE_OPERATOR_SHEET_OPTION_SPACING = 12.dp
internal val TILE_OPERAND_SHEET_MAX_HEIGHT = 320.dp
internal val TILE_OPERAND_SHEET_PADDING = 20.dp
internal val TILE_OPERAND_SHEET_COMPACT_TOP_PADDING = 8.dp
...
internal val SUCCESS_OVERLAY_BADGE_ICON_SIZE = 28.dp
internal val SUCCESS_OVERLAY_GUIDANCE_ICON_SIZE = 24.dp
internal const val PERSONAL_RECORD_CONFETTI_DURATION_MILLIS = 1_500
internal const val COMPLETION_BOARD_FEEDBACK_SCALE = 0.985f
internal const val COMPLETION_BOARD_SCALE_DOWN_DURATION_MILLIS = 90
internal const val COMPLETION_BOARD_SCALE_UP_DURATION_MILLIS = 170
internal const val COMPLETION_OVERLAY_INITIAL_SCALE = 0.96f
internal const val COMPLETION_OVERLAY_ENTRANCE_DURATION_MILLIS = 260
