...
object GameScreenTestTags {
    ...
    const val SUCCESS_OVERLAY_BADGE = "success_overlay_badge"
    const val SUCCESS_OVERLAY_HIGHLIGHT = "success_overlay_highlight"
    const val SUCCESS_OVERLAY_CONTEXT = "success_overlay_context"
    const val SUCCESS_OVERLAY_GUIDANCE = "success_overlay_guidance"
    const val SUCCESS_OVERLAY_GUIDANCE_HINT_ICON = "success_overlay_guidance_hint_icon"
    const val SUCCESS_OVERLAY_GUIDANCE_HELP_ICON = "success_overlay_guidance_help_icon"
    const val SUCCESS_OVERLAY_CONFETTI = "success_overlay_confetti"
    ...
    const val STRIP_ENTRY_CLEAR_ACTION = "strip_entry_clear_action"
    ...
    const val TILE_OPERATOR_SELECTOR_TITLE = "tile_operator_selector_title"
    const val TILE_OPERATOR_SELECTOR_EXPRESSION = "tile_operator_selector_expression"
